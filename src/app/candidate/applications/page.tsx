  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-sm text-muted-foreground">Track where you are in the hiring pipeline.</p>
      </div>
          ...
          <article key={app.id} className="rounded-xl border border-border p-4">
            <div className="flex flex-wrap items-center justify-between gap-2">
              <div>
                ...
                <p className="text-sm text-muted-foreground">{app.job.department?.name ?? "—"}</p>
              </div>
